...
| Ticket safety and accordion disclosure | workout.spec.ts | Safety guidance is present; Block 1 opens first; one phase stays open; summaries, effort strips, regions and arrow-key focus remain accessible |
